...
namespace DoctrineORMModule\Proxy\__CG__\DtlRealtor\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Realtor extends \DtlRealtor\Entity\Realtor implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'timestamp', 'commission', 'fixedCommission', 'bonus', 'isActive', 'user', 'supplier', 'person');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Realtor $proxy) {
