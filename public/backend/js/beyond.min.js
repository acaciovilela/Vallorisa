...
function InitiateSideMenu() {
    ...
    $("#sidebar-collapse").find(".collapse-icon").on("click", function () {
        $("#sidebar").toggleClass("menu-compact");
        $(this).hasClass("fa-arrow-right") ? $(this).removeClass("fa-arrow-right").addClass("fa-arrow-left") : $(this).removeClass("fa-arrow-left").addClass("fa-arrow-right");
...
function InitiateWidgetBoxes() {
    $(".widget-toolbar *[data-toggle]").on("click", function (n) {
        var i = $(this), h = i.data("toggle"), t = i.parents(".widget-box").eq(0), u, f, r;
        switch (h) {
            case"maximize":
                button = i.find("i").eq(0);
                u = "fa-compress";
                f = "fa-expand";
                t.hasClass("maximized") ? (button && button.addClass(f).removeClass(u), t.removeClass("maximized"), t.find(".widget-body").css("height", "auto")) : (button && button.addClass(u).removeClass(f), t.addClass("maximized"), maximize(t));
                break;
            case"collapse":
                r = t.find(".widget-body");
                button = i.find("i").eq(0);
                var e = "fa-plus", o = "fa-minus", s = 300;
                t.hasClass("collapsed") ? (button && button.addClass(o).removeClass(e), t.removeClass("collapsed"), r.slideUp(0, function () {
                    r.slideDown(s)
                })) : (button && button.addClass(e).removeClass(o), r.slideUp(200, function () {
...
var themeprimary = getThemeColorFromCss("themeprimary"), themesecondary = getThemeColorFromCss("themesecondary"), themethirdcolor = getThemeColorFromCss("themethirdcolor"), themefourthcolor = getThemeColorFromCss("themefourthcolor"), themefifthcolor = getThemeColorFromCss("themefifthcolor"), popovers, hoverpopovers;
$("#skin-changer li a").click(function () {
    createCookie("current-skin", $(this).attr("rel"), 10);
    window.location.reload()
});
$(window).load(function () {
    location.pathname != "/index.html" ? setTimeout(function () {
...
$.each(popovers, function () {
    $(this).popover({html: !0, template: '<div class="popover ' + $(this).data("class") + '"><div class="arrow"><\/div><h3 class="popover-title ' + $(this).data("titleclass") + '">Popover right<\/h3><div class="popover-content"><\/div><\/div>'})
});
