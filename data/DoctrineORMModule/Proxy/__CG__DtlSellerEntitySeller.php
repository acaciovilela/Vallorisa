...
namespace DoctrineORMModule\Proxy\__CG__\DtlSeller\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Seller extends \DtlSeller\Entity\Seller implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'timestamp', 'isActive', 'person');
        }
