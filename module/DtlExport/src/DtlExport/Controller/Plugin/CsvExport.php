...
namespace DtlExport\Controller\Plugin;

use Zend\Http\PhpEnvironment\Response as HttpResponse;
use Zend\Mvc\Controller\Plugin\AbstractPlugin;

/**
 * Easily export data to downloadable MS Excel files.
 */
class CsvExport extends AbstractPlugin {
     ...
     */
    public function __invoke($filename = null, $header = null, $data = null, callable $callback = null, $delimiter = ',', $enclosure = '"') {
        if (func_num_args() == 0) {
            return $this;
